  ...
  class TileInteractDialog extends FormApplication {
    ...
    static get defaultOptions() {
      return mergeObject(super.defaultOptions, {
        ...
        template: "modules/tiles-interactive-submenu/templates/interact-dialog.html",
        width: 600,
        height: 700,
        resizable: true,
    ...
    getData() {
      return {
        interactions: this.tile.getFlag("tiles-interactive-submenu", "interactions") || []
      };
    }
  
    async _updateObject(event, formData) {
      const data = expandObject(formData);
      await this.tile.setFlag("tiles-interactive-submenu", "interactions", data.interactions);
    }
    ...
    activateListeners(html) {
      ...
      html.find(".add-interaction").click(ev => {
        const interactions = this.tile.getFlag("tiles-interactive-submenu", "interactions") || [];
        ...
        this.tile.setFlag("tiles-interactive-submenu", "interactions", interactions);
        this.render();
      });
      ...
      html.find(".delete-interaction").click(ev => {
        const index = Number(ev.currentTarget.closest(".interaction-card").dataset.index);
        const interactions = this.tile.getFlag("tiles-interactive-submenu", "interactions") || [];
